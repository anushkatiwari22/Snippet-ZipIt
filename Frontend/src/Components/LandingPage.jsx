        ...
        <section className="min-h-[80vh] flex items-center grid grid-cols-1 md:grid-cols-2 gap-12 py-12">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <p className="text-base md:text-lg text-slate-700 leading-relaxed font-medium max-w-md">
              Discover what to learn next, improve your resume, track your
              progress, and move confidently toward your dream role.
            </p>
            ...
            <div className="flex items-center gap-5 mt-2">
              <Link
                to="/signup"
                className="bg-gradient-to-r from-[#ff517b] to-[#f83f6c] text-white text-sm font-bold px-8 py-3.5 rounded-full shadow-lg hover:brightness-105 active:scale-95 transition-all"
              >
                Sign up
              </Link>
              <Link
        ...
        <section id="about" className="pt-16 scroll-mt-24">
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-white/60 shadow-xl">
            ...
            <p className="text-base text-slate-700 leading-relaxed max-w-3xl mb-8 font-medium">
              ...
              Most career guidance is one-size-fits-all. We built an AI-powered
              platform that understands your goals, analyzes your progress, and
              helps you make smarter career decisions. From learning new skills
              to landing your dream job, we're your personalized career
              companion.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-pink-50/80 p-6 rounded-2xl border border-pink-100 shadow-sm">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Get career recommendations based on your interests and
                  strengths.
                </p>
              </div>
              <div className="bg-pink-50/80 p-6 rounded-2xl border border-pink-100 shadow-sm">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Follow personalized roadmaps and stay consistent with daily
                  goals.
                </p>
              </div>
              <div className="bg-pink-50/80 p-6 rounded-2xl border border-pink-100 shadow-sm">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Receive AI-powered insights on resumes, projects, and
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-white/60 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-xl">
              ...
              <p className="text-base text-slate-700 leading-relaxed mb-8 font-medium">
                From choosing the right skills to preparing for interviews, our
                AI mentor provides personalized guidance at every stage of your
                career journey.
              </p>
            </div>
        ...
        <section id="contact" className="pt-16 pb-24 scroll-mt-24">
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-white/60 shadow-xl max-w-2xl mx-auto">
            ...
            <p className="text-sm text-slate-600 mb-8 text-center font-medium">
              Have questions or want to build something amazing together? Reach
              out to us.
            </p>
